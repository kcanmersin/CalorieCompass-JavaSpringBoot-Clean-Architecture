...
public class UserController {
    ...
    @GetMapping("/user")
    @ResponseBody
    @Operation(summary = "Get user profile", description = "Get current user's profile information", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    private Long getUserIdFromAuthentication() {
        ...
        String email = authentication.getName();
        return authService.findUserByEmail(email).getId();
    }
}